...
const Ticket = (props) => {
    ...
    useEffect(() => {
        setInterval(() => getTimeUntil(2 * 60), 1000);
      }, []);
    ...
    return(
        <Layout>
            ...
            <div className={classes.timer}>
                ...
                <div className={classes.time}>Timmer:  {state.minutes} : {state.seconds}</div> 
            </div>
                ...
                <div className={classes.body}>
                    <div className={classes.left}>
                        ...
                        <div className={classes.method}>
                            <div className={classes.method_title}>Delivery Title</div>
                            <div className={classes.radio_field}>
                                <input type="radio" className={classes.radio} />
                                <div className={classes.radio_text}>
                                    Mobile Delivery (scane from mobile) - canada only 0$
                                </div>
                            </div>
                            <div className={classes.radio_field}>
                                <input type="radio" className={classes.radio} />
                                <div className={classes.radio_text}>
                                    Print at home tickets by Link - canada only 0$
                                </div>
                            </div>
                            <div className={classes.radio_field}>
                                <input type="radio" className={classes.radio} />
                                <div className={classes.radio_text}>
                                    Will Call - Pickup at Box Office - 0.00$
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className={classes.right}>
                        ...
                        <button className={classes.continueShopping}>
                            ...
                            <div className={classes.shopping_text}>Romove Entrie Order</div>
                        </button>
                    </div>
                </div>
            </div>
